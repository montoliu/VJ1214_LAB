...
\input{c5.tex} % Introduccion a la memoria grafica
\input{c6.tex} % Modo framebuffer
\input{c7.tex} % Modo teselado
\input{c8.tex} % Entrada salida
\input{c9.tex} % Entrada salida en la NDS
\input{c10.tex} % Juego con gráficos
